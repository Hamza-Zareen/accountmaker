...
public class AccountController {
    ...
    public ResponseEntity<Object> createAccount(@RequestBody CreateAccountRequest createAccountRequest){
        try {
            ...
            return Util.responseEntity("Error occurred while creating account for customerId: " + createAccountRequest.getCustomerId(), RestAPIResponseStatus.Error, ex.getMessage());
        }
    }
}
